...
`;
  const projects = [
    ...
    },
    {
      ...
      description:
        "This package is to check if the given country-code/country-name is part of the EU (European Union) or EEA (European Economic Area). This is published on <a href='https://npmjs.com/' target='_blank'  rel='noopener noreferrer'> npmjs.com. </a>.",
    ...
    },
    {
      ...
      description:
        "Official Documentations for `eu-country-check` package. This is server side rendered web-app built using node.js, express & react.",
    ...
    },
    {
      ...
      description:
        "A server side rendered web-app built on next.js with prismic legacy builder. This app serves static pages as well as server side rendered pages according best case scenarios so page loads as quick as possible.",
    ...
    },
    {
      ...
      description:
        "Boilerplate to built single page applications using react. Tech-stack used Webpack as bundler, babel for transpile JS & github-pages for deployment.",
    ...
    },
    {
      ...
      description:
        "Build to learn server routing in Server-Side-Rendered node-react app. Technologies used to build this application is Node, express, vercel, react & webpack.",
    ...
    },
    {
      ...
      description:
        "A blog website made to become familiar with gatsby.js. This project is created by following <a href='https://www.gatsbyjs.com/docs/tutorial/getting-started/' target='_blank'  rel='noopener noreferrer'> official tutorials </a>.",
